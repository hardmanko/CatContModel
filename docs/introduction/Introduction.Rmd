...
We can see that there is a marginal main effect of letters when nothing else is considered. However, when the main effect of numbers is included in the design, the parameters associated with the `2` and `3` levels of the numbers factor account for the apparent marginal lettters effect. Thus, main effects can be affected by the inclusion of other main effects.
