...
author: "Kyle Hardman"
date: "Package version 0.7.4, March 2017"
output: pdf_document
linkcolor: blue
...
When working with non-fully-crossed designs, you have to choose what main effects or interactions to account for as it has implications for the results. 
This is difficult to do with the function `testMainEffectsAndInteractions`. It only includes terms up to and including the tested effect. For example, if you are testing two-factor interaction, it will estimate that interaction and the two associated main effects. If there is a third factor, it will not estimate the main effect of that third factor or any interactions including that third factor.
...
Working Memory Models for Delayed Estimation Tasks (Version 0.7.4) [Computer software]. Retrieved from
https://github.com/hardmanko/CatContModel/releases/tag/v0.7.4
