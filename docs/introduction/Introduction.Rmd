...
for (grp in names(dataSets)) {
	...
	groups[[ grp ]] = runParameterEstimation(
											config = configs[[ grp ]], 
											data = dataSets[[ grp ]], 
...
For a reference specifically related to how the models are modified in order to allow for the use of linear data, reference @RickerHardman2017.
